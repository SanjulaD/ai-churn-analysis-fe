        ...
        try {
            ...
            const mockData: SegmentDeepDiveData = {
                segmentDistribution: [
                    ...
                    { segment: SegmentType.LOYAL_CUSTOMERS, count: 380, percentage: 24.1 },
                    { segment: SegmentType.POTENTIAL_LOYALISTS, count: 320, percentage: 20.3 },
                    { segment: SegmentType.AT_RISK, count: 280, percentage: 17.7 },
                    { segment: SegmentType.CANNOT_LOSE_THEM, count: 150, percentage: 9.5 }
                ],
                paymentTypes: [
                    { method: PaymentMethod.CREDIT_CARD, value: 45, color: '#3b82f6' },
                    { method: PaymentMethod.BANK_TRANSFER, value: 30, color: '#10b981' },
                    { method: PaymentMethod.ELECTRONIC_CHECK, value: 15, color: '#f59e0b' },
                    { method: PaymentMethod.MAILED_CHECK, value: 10, color: '#ef4444' }
                ],
                topProducts: [
                    { product: 'Premium Plan', segment: SegmentType.CHAMPIONS, sales: 245 },
                    { product: 'Standard Plan', segment: SegmentType.LOYAL_CUSTOMERS, sales: 189 },
                    { product: 'Basic Plan', segment: SegmentType.POTENTIAL_LOYALISTS, sales: 156 },
                    { product: 'Fiber Internet', segment: SegmentType.CHAMPIONS, sales: 134 },
